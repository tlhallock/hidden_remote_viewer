...
public class DaemonFrame extends javax.swing.JFrame {
    ...
    private void getServerPanel()
    {
        final ServerConnectionsPanel panel = new ServerConnectionsPanel();
        jPanel2.add(panel);
        jPanel2.addComponentListener(new ComponentAdapter() {
            @Override
            public void componentResized(ComponentEvent ce) {
                panel.setBounds(0,0,jPanel2.getWidth(), jPanel2.getHeight());
            }
        });
    ...
    {
        final ClientConnectionsPanel panel = new ClientConnectionsPanel();
        jPanel1.add(panel);
    ...
    private void initComponents() {
        ...
        jButton2.setText("Open peer settings");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaemonFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
